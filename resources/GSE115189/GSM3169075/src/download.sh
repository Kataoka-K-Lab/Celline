...
#PBS -j eo
#PBS -m ae
#PBS -e ./resources/GSE115189/GSM3169075/logs/download_20250602_20:51:14.log
...
###################
filetype="bam"
sample_id="GSM3169075"

mkdir -p "./resources/GSE115189/GSM3169075/raw" && cd "./resources/GSE115189/GSM3169075/raw"
