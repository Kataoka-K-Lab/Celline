...
#PBS -j eo
#PBS -m ae
#PBS -e /Users/yuyasato/Documents/dev/Celline/resources/GSE157783/GSM4774931/logs/download_20250602_20:47:18.log
...
###################
filetype="fastq"
sample_id="GSM4774931"

mkdir -p "/Users/yuyasato/Documents/dev/Celline/resources/GSE157783/GSM4774931/raw" && cd "/Users/yuyasato/Documents/dev/Celline/resources/GSE157783/GSM4774931/raw"

if [ "$filetype" = "bam" ]; then
    if [ ! -f "$sample_id.bam" ]; then
        wget "" -O "$sample_id.bam"
    fi
    ...
    IFS=',' read -ra run_ids <<<"SRR12621861,SRR12621862"
